...
from Models.BasicModels import (build_icm_state_encoder, build_icm_inverse_model, build_icm_discrete_forward_model,
    build_icm_continuous_forward_model)
...
class ICMModel(ABC):
    ...
    def save_weights(self, path):
        ...
        print_model_to_json_file(self.state_encoder, os.path.join(path, 'state_encoder_model'))
        print_model_to_json_file(self.inverse_model, os.path.join(path, 'forward_model'))
        print_model_to_json_file(self.forward_model, os.path.join(path, 'inverse_model'))
